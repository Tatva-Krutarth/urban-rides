...
function showSuccesstMsg(responseMessage) {
    showToast(
        {
            eleWrapper: '#example',
            msg: responseMessage,
...
function showErrorMsg(responseMessage) {
    showToast(
        {
            eleWrapper: '#example',
            msg: responseMessage,
...
function showWarningMsg(responseMessage) {
    showToast(
        {
            eleWrapper: '#example',
            msg: responseMessage,
...
function showMultipleMsg(responseMessage) {
